...
CMD [ "java", "-jar", "-Djavax.net.ssl.trustStore=etc/paas/openshift/certs/sometruststorecert.jks", "-Djavax.net.ssl.trustStorePassword=${kafkaTruststorePassword}", "kafkatool-webapp.jar", "-config=resources/application.conf" ]
