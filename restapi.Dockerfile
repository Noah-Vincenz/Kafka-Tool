...
CMD [ "java", "-jar", "-Djavax.net.ssl.trustStore=etc/paas/openshift/certs/sometruststorecert.jks", "-Djavax.net.ssl.trustStorePassword=${kafkaTruststorePassword}", "kafkatool-restapi.jar", "-config=resources/application.conf" ]